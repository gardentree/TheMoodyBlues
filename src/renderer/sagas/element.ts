...
// prettier-ignore
export default [
  takeLatest(principal.focusLatestTweet.toString(), focusLatestTweet),
  takeLatest(principal.focusUnreadTweet.toString(), focusUnreadTweet),
  takeEvery(principal.alarm.toString(), alarm),
];
